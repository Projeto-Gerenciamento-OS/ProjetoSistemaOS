        ...
        <div class="card-body "> 
                ...
                @method('POST')
                    ...
                    <div class="col-6 col-lg-6">
                        ...
                        <div class="mb-3">
                                ...
                                <input type="text"  name="start" id="start"  value="{{ old('start') }}" >
                        </div>
                        ...
                        <a class="btnCadastrar">
                            <button type="submit" data-target="div2">
                                <h5>Próximo</h5>
            ...
            <form action="{{ route('os1.store') }}" method="POST" class="osBody row g-3">
                ...
                @method('POST')
                   ...
                   {{-- OS2 --}}
                   <div class="col-6 col-lg-6  hidden"  id="div2"> 
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="ctotal" class="form-label">CUSTO</label>
                        <input type="text"  name="ctotal" id="ctotal">
                    </div> 
                    ...
                    <div  class="btnCadastrar" >
                        <button class='btn' data-target="div2">
                            <h5>Próximo</h5>
                            <i class="fa-solid fa-angle-right"></i>
                        </button>  
                    </div>
