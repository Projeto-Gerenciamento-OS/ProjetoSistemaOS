...
class Os4Controller extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        //Carregar a View
        return view('os4.index', ['os4', 'os4'=> $os4,'id_emp1_os4'=>$request->id_emp1_os4]);
    }
     ...
     public function store(Os4Request $request)
     {
         ...
         try {
             ...
             $os4 = Os4::create([
                 ...
                 'percentual_os4' => $request->percentual_os4,
                 'valor_os4' => $request->valor_os4,
                 'ativo_os4' => $request->ativo_os4,
                 'descricao_os4' => $request->descricao_os4,
             ]);
             ...
             return redirect()->route('os4.index', ['os4' => $os4->id])->with('success', 'Os4 cadastrado com sucesso!');
         } catch (Exception $e) {
    ...
    public function delete(Os4 $os4){
        try {
            ...
            return redirect()->route('os4.index')->with('success', 'Os4 excluído com sucesso!');
