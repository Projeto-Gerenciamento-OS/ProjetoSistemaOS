...
class Os4Controller extends Controller
{
    ...
    public function store(Os4Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('os.index', $os2)->with('success', 'Os4 criada com sucesso!');
            // return redirect()->route('os4.create', ['os4' => $os4->id])->with('success', 'Os4 cadastrado com sucesso!');
        } catch (Exception $e) {
